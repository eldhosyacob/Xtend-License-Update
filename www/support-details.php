...
<body>
  ...
  <div class="page-containers">
    ...
    <div class="search-container" style="margin-bottom: 24px; display:flex; justify-content:center;">
      <div
        ...
        <div style="width:1px; background:#e2e8f0; height:50px; display:none; @media(min-width: 600px){display:block;}">
        </div>
        ...
        <div style="display:flex; flex-direction:column; gap:8px;">
          <label for="searchLocationCode" style="font-weight:600; font-size:14px; color:#374151;">Location
            Code</label>
          <div style="display:flex; align-items:center; gap:8px;">
            <input type="text" id="searchLocationCode" class="form-control" placeholder="Enter Location Code..."
              autocomplete="off"
              style="width:220px; padding: 10px 14px; border: 1px solid #cbd5e1; border-radius: 6px; transition: all 0.2s;">
      ...
      <form id="supportForm"
        ...
        <div style="margin-bottom:28px; padding-bottom:20px; border-bottom:2px solid #f1f5f9;">
          ...
          <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:16px;">
            <div>
              <label style="display:block; font-weight:500; margin-bottom:6px; color:#475569; font-size:14px;">Device
                ID 1</label>
        ...
        <div style="margin-bottom:28px; padding-bottom:20px; border-bottom:2px solid #f1f5f9;">
          ...
          <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(300px, 1fr)); gap:16px;">
            ...
            <div>
              ...
              <input type="number" name="Centralization[LiveStatusUrlInterval]" disabled class="form-input">
            </div>
            <div>
              <label
            ...
            <div>
              ...
              <input type="number" name="Centralization[UploadFileUrlInterval]" disabled class="form-input">
            </div>
            <div>
              <label
        ...
        <div style="margin-bottom:28px; padding-bottom:20px; border-bottom:2px solid #f1f5f9;">
          ...
          <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(250px, 1fr)); gap:16px;">
            <div>
              ...
              <input type="text" name="Features[Script]" disabled class="form-input" style="width:25% !important;">
            </div>
          </div>
        </div>
            ...
            <div style="display:flex; flex-direction:column; align-items:flex-start; gap:4px;">
              ...
              <div style="font-size:12px; color:#64748b; font-weight:500;">
                Current Device Status: <span id="currentDeviceStatusText"
                  style="color:#017f73; font-size:11px; font-weight:500;"></span>
              </div>
            </div>
          </div>
          <div>
            ...
            <div style="display:flex; align-items:center; gap:8px;">
              <input type="date" name="StatusDate" id="StatusDateInput" class="form-input" style="width:140px;">
        ...
        <div style="margin-bottom:24px;">
          ...
          <input type="text" name="TestedBy" id="TestedByInput" class="form-input" style="width:25%; max-width:500px;">
        </div>

        <!-- Support Remarks (Editable) - New Field -->
        <div style="margin-bottom:24px;">
          <label style="display:block; font-weight:500; margin-bottom:6px; color:#475569; font-size:14px;">Support
            Remarks</label>
  ...
  <script>
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.success && response.data) {
            ...
            showToast(response.message || 'Error fetching details', 'error');
          }
        },
        error: function () {
          showLoading(false);
    ...
    function populateForm(data) {
      ...
      $('#currentDeviceStatusText').text(data.latest_device_status || data.device_status || '');
